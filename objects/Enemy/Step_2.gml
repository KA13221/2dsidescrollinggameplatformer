...
/// @DnDVersion : 1.1
/// @DnDHash : 58595B92
/// @DnDComment : If were on the ground
/// @DnDArgument : "x_relative" "1"
/// @DnDArgument : "y" "2"
/// @DnDArgument : "y_relative" "1"
/// @DnDArgument : "object" "collision_tilemap"
var l58595B92_0 = instance_place(x + 0, y + 2, [collision_tilemap]);if ((l58595B92_0 > 0)){	/// @DnDAction : YoYo Games.Common.If_Variable
	/// @DnDVersion : 1
	/// @DnDHash : 762D0471
	...
	if(move_x <= -1){	/// @DnDAction : YoYo Games.Instances.Set_Sprite
		...
		/// @DnDVersion : 1
		/// @DnDHash : 1049A830
		/// @DnDComment : flip the image X scale (absoulute value incase the image does not flip)
		/// @DnDParent : 762D0471
	...
	if(move_x >= 1){	/// @DnDAction : YoYo Games.Instances.Set_Sprite
		...
		/// @DnDVersion : 1
		/// @DnDHash : 65DC2785
		/// @DnDComment : reset the X-scale image back to normal (absolute value to make it positive to the right no matter what)
		/// @DnDParent : 07D50CA1
